...
def main():
    ...
    for name, snap in snapshots.items():
        ...
        for key, value in snap['effective'].items():
            ...
            elif inputs and key == 'orca_matrix_flush_multiplier':
                origin = 'orca_project_default_outside_profile_snapshot'
            elif inputs and key in ('orca_perimeter_speed_compatibility', 'retract_before_perimeters', 'orca_fixed_prime_volume', 'orca_wipe_compatibility', 'orca_matrix_flush', 'orca_toolchange_timing'):
