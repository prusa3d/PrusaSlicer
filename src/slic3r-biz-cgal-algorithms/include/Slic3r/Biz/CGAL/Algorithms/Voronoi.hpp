...
private:
    struct Segment
    {
        ...
        Segment() = delete;
        explicit Segment(const Domain::Point &from, const Domain::Point &to) : from(from), to(to) {}
    };
...
public:
    using SegmentIt = std::vector<Slic3r::Biz::CGAL::Algorithms::VoronoiDiagram::Segment>::iterator;

    friend struct boost::polygon::segment_traits<Slic3r::Biz::CGAL::Algorithms::VoronoiDiagram::Segment>;
};

} // namespace Slic3r::Geometry

namespace boost::polygon {
template<> struct geometry_concept<Slic3r::Biz::CGAL::Algorithms::VoronoiDiagram::Segment>
{
    typedef segment_concept type;
};

template<> struct segment_traits<Slic3r::Biz::CGAL::Algorithms::VoronoiDiagram::Segment>
{
    using coordinate_type = Slic3r::Domain::coord_t;
    using point_type      = Slic3r::Domain::Point;
    using segment_type    = Slic3r::Biz::CGAL::Algorithms::VoronoiDiagram::Segment;
