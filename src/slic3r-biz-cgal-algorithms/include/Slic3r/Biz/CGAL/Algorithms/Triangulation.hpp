...
public:
    ...
    using Indices   = std::vector<Domain::Index3>;
    ...
    static Indices triangulate(const Domain::Points &points,
                               const HalfEdges &half_edges);
    static Indices triangulate(const Domain::Polygon &polygon);
    static Indices triangulate(const Domain::Polygons &polygons);
    static Indices triangulate(const Domain::ExPolygon &expolygon);
    static Indices triangulate(const Domain::ExPolygons &expolygons);
    ...
    static Changes create_changes(const Domain::Points &points, const Domain::Points &duplicits);
    ...
    static Indices triangulate(const Domain::ExPolygons &expolygons, const Domain::Points& points);
    ...
    /// <returns>Triangle indices</returns>
    static Indices triangulate(const Domain::ExPolygons &expolygons, const Domain::Points& points, const Changes& changes);
};
