...
public:
    ...
    static Domain::coord_t to_coord(const VD::coordinate_type &coord);
    ...
    static Domain::Point to_point(const VD::vertex_type *vertex);
    ...
    static VD::point_type to_point(const Domain::Point &point);
    ...
    static Domain::Vec2d to_point_d(const VD::vertex_type* vertex);
    ...
    static VD::segment_type to_segment(const Domain::Line &line);
    ...
    static Domain::Point to_direction(const VD::edge_type *edge);
    ...
    /// <param name="edge">input</param>
    /// <returns>direction --> (vertex1 - vertex0)</returns>
    static Domain::Vec2d to_direction_d(const VD::edge_type *edge);
...
private:
    ...
    static Domain::Line create_line_between_source_points(
...
public:
    ...
    static std::optional<Domain::Line> to_line(const VD::edge_type &edge,
    ...
    static Domain::Polygon to_polygon(const Domain::Lines &lines,
    ...
    static Domain::Point retrieve_point(const Domain::Lines &lines, const VD::cell_type &cell);
    ...
    static const Domain::Point& retrieve_point(const Domain::Points &points, const VD::cell_type &cell);
...
private:
    ...
    static Domain::Point get_parabola_point(const VD::edge_type &parabola, const Domain::Lines &lines);
    ...
    static Domain::Line get_parabola_line(const VD::edge_type &parabola, const Domain::Lines &lines);
...
public:
    ...
    static Biz::Algorithms::Parabola get_parabola(const VD::edge_type &edge, const Domain::Lines &lines);
    ...
    static double calculate_length_of_parabola(const VD::edge_type &edge, const Domain::Lines &lines);
    ...
    static double calculate_length(const VD::edge_type &edge, const Domain::Lines &lines);
    ...
    static double calculate_max_width(const VD::edge_type &edge, const Domain::Lines &lines);
    ...
    static std::pair<Domain::coord_t, Domain::coord_t> calculate_width(const VD::edge_type &edge, const Domain::Lines &lines);

private:
    static std::pair<Domain::coord_t, Domain::coord_t> calculate_width_for_line(
        const VD::edge_type &line_edge, const Domain::Lines &lines);
    static std::pair<Domain::coord_t, Domain::coord_t> calculate_width_for_parabola(
        const VD::edge_type &parabola_edge, const Domain::Lines &lines);
    static std::pair<Domain::coord_t, Domain::coord_t> min_max_width(const VD::edge_type &edge, const Domain::Point &point);
...
public:
    ...
    static VoronoiGraph create_skeleton(const VD &vd, const Domain::Lines &lines);
    ...
    static bool is_opposit_direction(const VD::edge_type *edge, const Domain::Line &line);
    ...
    static Domain::Point create_edge_point(const VoronoiGraph::Position& position);
    static Domain::Point create_edge_point(const VD::edge_type *edge, double ratio);
    ...
    static std::pair<Domain::Point, Domain::Point> point_on_lines(
    ...
    static Domain::coord_t get_max_width(const VoronoiGraph::ExPath &longest_path);
    static Domain::coord_t get_max_width(const VoronoiGraph::Nodes &path);
    static Domain::coord_t get_max_width(const VoronoiGraph::Node *node);
    ...
    static bool ends_in_distanace(const VoronoiGraph::Position &position, Domain::coord_t max_distance);
    ...
    static double outline_angle(const VoronoiGraph::Node::Neighbor &neighbor, const Domain::Lines& lines);
    ...
    static void for_neighbor_at_distance(
        const VoronoiGraph::Position &position,
        Domain::coord_t                       max_distance,
        std::function<void(const VoronoiGraph::Node::Neighbor &, Domain::coord_t)> fnc);
