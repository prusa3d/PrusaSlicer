...
public:
    ...
    static double length(const Biz::Algorithms::ParabolaSegment &parabola);
    ...
    /// <returns>Length of parabola arc</returns>
    static double length_by_sampling(const Biz::Algorithms::ParabolaSegment &parabola,
    ...
    static double focal_length(const Biz::Algorithms::Parabola &parabola);
    ...
    static bool is_over_zero(const Biz::Algorithms::ParabolaSegment &parabola);
    ...
    static void draw(Biz::Algorithms::SVG::SVG &                  svg,
                     const Biz::Algorithms::ParabolaSegment &parabola,
                     const char *           color,
