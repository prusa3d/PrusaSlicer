...
public:
    ...
    static typename boost::polygon::enable_if<
        typename boost::polygon::gtl_if<typename boost::polygon::is_segment_concept<
            typename boost::polygon::geometry_concept<typename std::iterator_traits<SegmentIterator>::value_type>::type>::type>::type, Biz::Algorithms::PolygonsPointIndex>::type
    ...
    static typename boost::polygon::enable_if<typename boost::polygon::gtl_if<typename boost::polygon::is_segment_concept<
        ...
        Domain::Points>::type
    discretize_parabola(const Domain::Point &source_point, const Segment &source_segment, const Domain::Point &start, const Domain::Point &end, Domain::coord_t approximate_step_size, float transitioning_angle);
