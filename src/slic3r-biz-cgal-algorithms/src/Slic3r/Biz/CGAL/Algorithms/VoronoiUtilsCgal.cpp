...
using Slic3r::Biz::Algorithms::PolygonsSegmentIndex;
using Domain::Point;
using Domain::Line2d;
using Domain::Vec2d;
using Domain::Line;
using Domain::Lines;
using Slic3r::Biz::Algorithms::ColoredLines;
...
inline Line2d make_linef(const VD::edge_type &edge)
{
