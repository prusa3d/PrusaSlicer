...
ExpandNeighbor::ExpandNeighbor(NodeDataWithResult& data, const VoronoiGraph::Node::Neighbor& neighbor):
    data(data),
    neighbor(neighbor)
{}

void ExpandNeighbor::process(Biz::Algorithms::CallStack &call_stack)
{
