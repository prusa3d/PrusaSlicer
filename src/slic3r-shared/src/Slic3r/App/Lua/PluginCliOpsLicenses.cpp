...
// List of known license identifier by spdx
// obtained by running:
// curl -L https://github.com/spdx/license-list-data/raw/refs/heads/main/json/licenses.json | jq '[.licenses.[].licenseId]'

const std::vector<std::string> KNOWN_LICENSES = {
    "0BSD",
    "3D-Slicer-1.0",
    "AAL",
    "Abstyles",
