...
public:
    ...
    static bool is_equal(const Domain::Point &p1, const Domain::Point &p2);
    ...
    static bool is_majorit_x(const Domain::Point &point);
    static bool is_majorit_x(const Domain::Vec2d &point);
    ...
    static Domain::Point perp(const Domain::Point &vector);
    ...
    static bool is_same_direction(const Domain::Point &dir1, const Domain::Point &dir2);
};
