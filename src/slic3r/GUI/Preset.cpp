...
{    
    static std::vector<std::string> s_opts {
        ...
        "extrusion_multiplier", "filament_density", "filament_cost", "filament_loading_speed", "filament_enable_toolchange_temp", "filament_enable_toolchange_part_fan", "filament_toolchange_part_fan_speed", "filament_toolchange_temp", "filament_use_skinnydip", "filament_skinnydip_distance", "filament_melt_zone_pause", "filament_cooling_zone_pause", "filament_dip_insertion_speed", "filament_dip_extraction_speed", "filament_loading_speed_start", "filament_load_time",
