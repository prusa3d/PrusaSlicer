...
void NotificationManager::UpdatedItemsInfoNotification::add_type(InfoItemType type)
{
	...
	for (it = m_types_and_counts.begin(); it != m_types_and_counts.end(); ++it) {
        ...
        case InfoItemType::SurfaceTexture:      text += format(_L_PLURAL("%1$d object was loaded with surface texture painting.","%1$d objects were loaded with surface texture painting.", (*it).second), (*it).second) + "\n"; break;
