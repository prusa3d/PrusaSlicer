...
public:
    ...
    std::string get_host() const override { return default_host(); }
...
private:
    ...
    std::string extract_model_name(const std::string &input) const;
    ...
    //void get_cloud_project_list(wxArrayString &projects) const;
    //void get_cloud_printer_types(wxArrayString &printer_types, const std::string &pattern = "") const;
};
