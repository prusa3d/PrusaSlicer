...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionInts,               bridge_aux_fan_speed))
    ...
    ((ConfigOptionBools,              enable_dynamic_aux_fan_speeds))
    ((ConfigOptionInts,               overhang_aux_fan_speed_0))
    ((ConfigOptionInts,               overhang_aux_fan_speed_1))
    ((ConfigOptionInts,               overhang_aux_fan_speed_2))
    ((ConfigOptionInts,               overhang_aux_fan_speed_3))
    ...
    ((ConfigOptionInts,               disable_aux_fan_first_layers))
    ((ConfigOptionInts,               disable_fan_first_layers))
    ((ConfigOptionEnum<DraftShield>,  draft_shield))
    ((ConfigOptionFloat,              duplicate_distance))
    ((ConfigOptionBools,              enable_aux_fan))
    ...
    ((ConfigOptionInts,               aux_fan_below_layer_time))
    ...
    ((ConfigOptionInts,               full_aux_fan_speed_layer))
    ((ConfigOptionInts,               full_fan_speed_layer))
    ((ConfigOptionFloat,              infill_acceleration))
    ((ConfigOptionBool,               infill_first))
    ((ConfigOptionInts,               max_aux_fan_speed))
    ((ConfigOptionInts,               max_fan_speed))
    ((ConfigOptionFloats,             max_layer_height))
    ((ConfigOptionInts,               min_aux_fan_speed))
