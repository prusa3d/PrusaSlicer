...
///|/
#ifndef slic3r_FillShwartzDiamond_hpp_
#define slic3r_FillShwartzDiamond_hpp_
...
class FillShwartzDiamond : public Fill
{
public:
    FillShwartzDiamond() {}
    Fill* clone() const override { return new FillShwartzDiamond(*this); }
...
#endif // slic3r_FillShwartzDiamond_hpp_
