...
public:
    ...
    static std::string set_fan(const GCodeFlavor gcode_flavor, bool gcode_comments, unsigned int speed, unsigned int index = 0);
    ...
    std::string set_fan(unsigned int speed, unsigned int index = 0) const;
