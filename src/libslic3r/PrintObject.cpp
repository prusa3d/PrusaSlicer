    ...
    const ConfigOptionResolver &old_config, const ConfigOptionResolver &new_config, const std::vector<t_config_option_key> &opt_keys)
{
    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (   opt_key == "brim_width"
            ...
            || opt_key == "texture_skin"
            || opt_key == "texture_skin_pattern"
            || opt_key == "texture_skin_uv_mode"
            || opt_key == "texture_skin_amplitude"
            || opt_key == "texture_skin_point_dist"
            || opt_key == "texture_skin_uv_scale"
            || opt_key == "texture_skin_uv_offset_u"
            || opt_key == "texture_skin_uv_offset_v"
            || opt_key == "texture_skin_uv_rotation"
            || opt_key == "texture_skin_mapping_blend"
            || opt_key == "texture_skin_custom_image"
            || opt_key == "overhangs"
            || opt_key == "thin_walls"
