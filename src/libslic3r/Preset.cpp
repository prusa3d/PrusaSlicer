...
static std::vector<std::string> s_Preset_print_options {
    ...
    "texture_skin", "texture_skin_pattern", "texture_skin_uv_mode", "texture_skin_amplitude", "texture_skin_point_dist",
    "texture_skin_uv_scale", "texture_skin_uv_offset_u", "texture_skin_uv_offset_v", "texture_skin_uv_rotation",
    "texture_skin_mapping_blend", "texture_skin_custom_image",
