...
static std::vector<std::string> s_Preset_print_options {
    ...
    "textured_skin_enabled", "textured_skin_svg", "textured_skin_mapping", "textured_skin_thickness", "textured_skin_tile_size", "textured_skin_tile_height", "textured_skin_point_dist", "textured_skin_invert",
