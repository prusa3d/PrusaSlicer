...
static std::vector<std::string> s_Preset_print_options {
    ...
    "avoid_crossing_curled_overhangs", "avoid_crossing_perimeters", "avoid_crossing_printed_areas", "thin_walls", "overhangs",
    "seam_position", "staggered_inner_seams", "seam_gap_distance",
    "external_perimeters_first", "alternate_perimeter_order", "fill_density", "fill_pattern", "top_fill_pattern", "bottom_fill_pattern",
