...
using Domain::CoolingSlowdownLogicType;
...
bool GCodeMoveSegment::is_arc() const
{
    return (type & CoolingLine::TYPE_G2G3) != 0;
}

bool GCodeMoveSegment::is_ccw() const
{
    ...
    for (; *line_start != 0; line_start = line_end) 
    {
        ...
        if (line.type) {
            ...
            if ((line.type & CoolingLine::TYPE_G92) == 0) {
                ...
                assert(((line.type & CoolingLine::TYPE_G0) != 0)
                     + ((line.type & CoolingLine::TYPE_G1) != 0)
                     + ((line.type & CoolingLine::TYPE_G2G3) != 0) == 1);
