...
public:
	...
	// Has any support?
	bool 		has_support()				const { return m_object_config->get<Domain::SupportMode>("support_material") != Domain::SupportMode::None || m_object_config->get<int>("support_material_enforce_layers"); }
